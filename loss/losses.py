...
class depth_loss(nn.Module):
    def __init__(self):
        ...
        self.depth_decoder = networks.DepthDecoder(num_ch_enc=self.encoder.num_ch_enc,
                                                   scales=range(4))
        depth_decoder_path = 'loss/depth.pth'
...
class FocalLoss(nn.Module):
    def __init__(self, a=1, gamma=2, reduction='mean'):
    ...
    def forward(self, inputs, targets):
        ...
        F_loss = self.a * (1-pt)**self.gamma * BCE_loss
